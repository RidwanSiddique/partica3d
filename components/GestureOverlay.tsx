...
const gestureDescriptions: Record<string, string> = {
    ...
    open_palm: 'Open your palm with fingers spread',
    fist: 'Make a fist',
    swipe_left: 'Swipe your hand left',
    swipe_right: 'Swipe your hand right',
    rotate_cw: 'Rotate your wrist clockwise',
    rotate_ccw: 'Rotate your wrist counter-clockwise',
...
const gestureActions: Record<string, string> = {
    ...
    rotate_cw: '→ Rotate object',
    rotate_ccw: '→ Rotate object',
